...
ALLOWED_MODELS = {'iTransformer', 'DC-iTransformer', 'DC-iTransformer-GLU', 'iTransformer-GLU', 'PatchTST', 'TimeXer'}
...
class Exp_Basic(object):
    ...
    def _scan_models_directory(self):
        ...
        if 'DC-iTransformer-GLU' in ALLOWED_MODELS:
            model_map['DC-iTransformer-GLU'] = 'models.DC_iTransformer_GLU'
